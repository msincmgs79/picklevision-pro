  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white p-4">
      <div className="max-w-2xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">Auto-Detect Teams</h1>
        <div className="space-y-4">
          <button
            onClick={handleConfirmTeams}
            disabled={confirming}
            className="w-full px-4 py-3 bg-green-600 hover:bg-green-700 disabled:bg-gray-400 text-white rounded-lg font-semibold"
          >
            Confirm & Save
          </button>
          <button
