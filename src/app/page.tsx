  ...
  return (
    <div style={{ minHeight: '100vh', background: '#667eea', padding: '40px', fontFamily: 'Arial' }}>
      <div style={{ maxWidth: '1000px', margin: '0 auto', background: 'white', padding: '40px', borderRadius: '8px' }}>
        <h1 style={{ margin: '0 0 20px 0', color: '#333' }}>PickleVision</h1>
        <p style={{ margin: '0 0 20px 0', color: '#666' }}>Advanced Pickle Game Video Analysis</p>

        <div style={{ marginBottom: '30px' }}>
          <h2 style={{ margin: '0 0 10px 0', color: '#333' }}>Step {step} of 8</h2>
          <div style={{ width: '100%', height: '8px', background: '#e0e0e0', borderRadius: '4px', marginBottom: '20px' }}>
            <div style={{ width: (step / 8) * 100 + '%', height: '100%', background: '#667eea' }}></div>
          </div>
