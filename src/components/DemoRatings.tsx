...
// Demo/showcase version — shown when signed out or no analyzed match exists.
export default function DemoRatings() {
  ...
  return (
    <div>
      <div className="eyebrow">Progress · demo</div>
      <h1 className="page-title" style={{ marginTop: 6 }}>Ratings &amp; Team</h1>
      <p className="page-sub">Sample ratings — sign in and analyze a match to see your own.</p>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 12 }}>
          <div>
            ...
            <div className="muted" style={{ fontSize: 13, marginTop: 2, maxWidth: 520 }}>
              Export your match data and paste it into any AI chatbot to ask about your performance.
            </div>
          </div>
...
function buildExport(): string {
  ...
  return `PICKLEVISION MATCH EXPORT (sample)
